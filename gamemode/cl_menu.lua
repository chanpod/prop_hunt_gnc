...
function PHX.UI.BaseMainMenu(ply, cmd, args)
	...
	function PHX.UI:ShowAdminMenu()
		...
		-- GNC: Panic Mode settings
		PHX.UI:CreateVGUIType("ph_autotaunt_panic_enabled", "check", "SERVER", grid, "PHXM_ADMIN_PANIC_ENABLE")
		PHX.UI:CreateVGUIType("ph_autotaunt_panic_threshold", "slider", {min = 10, max = 180, init = PHX:GetCVar( "ph_autotaunt_panic_threshold" ) or 60, dec = 0, kind = "SERVER"}, grid, "PHXM_ADMIN_PANIC_THRESHOLD")
		PHX.UI:CreateVGUIType("ph_autotaunt_panic_delay", "slider", {min = 3, max = 30, init = PHX:GetCVar( "ph_autotaunt_panic_delay" ) or 10, dec = 0, kind = "SERVER"}, grid, "PHXM_ADMIN_PANIC_DELAY")
		...
		-- GNC: Ready-Up System settings
		PHX.UI:CreateVGUIType("ph_readyup_enabled", "check", "SERVER", grid, "PHXM_ADMIN_READYUP_ENABLE")
		PHX.UI:CreateVGUIType("ph_readyup_threshold", "slider", {min = 50, max = 100, init = PHX:GetCVar( "ph_readyup_threshold" ) or 80, dec = 0, kind = "SERVER"}, grid, "PHXM_ADMIN_READYUP_THRESHOLD")
		PHX.UI:CreateVGUIType("ph_readyup_countdown", "slider", {min = 5, max = 60, init = PHX:GetCVar( "ph_readyup_countdown" ) or 20, dec = 0, kind = "SERVER"}, grid, "PHXM_ADMIN_READYUP_COUNTDOWN")
		...
		PHX.UI:CreateVGUIType("","spacer",nil,grid,"" )
		PHX.UI:CreateVGUIType("", "label", "PHX.MenuCategoryLabel", grid, "PHXM_ADMIN_STATIONARY_TAUNT")
		PHX.UI:CreateVGUIType("ph_exp_stationary_taunt_enabled", "check", "SERVER", grid, "PHXM_ADMIN_STATIONARY_ENABLED")
		PHX.UI:CreateVGUIType("ph_exp_stationary_threshold", "slider", {min = 5, max = 120, init = GetConVar("ph_exp_stationary_threshold"):GetInt(), dec = 0, kind = "SERVER"}, grid, "PHXM_ADMIN_STATIONARY_THRESHOLD")
		PHX.UI:CreateVGUIType("ph_exp_stationary_min_duration", "slider", {min = 1, max = 30, init = GetConVar("ph_exp_stationary_min_duration"):GetFloat(), dec = 1, kind = "SERVER"}, grid, "PHXM_ADMIN_STATIONARY_MIN_DURATION")
		PHX.UI:CreateVGUIType("ph_exp_stationary_delay_mult", "slider", {min = 0.1, max = 1.0, init = GetConVar("ph_exp_stationary_delay_mult"):GetFloat(), dec = 2, kind = "SERVER"}, grid, "PHXM_ADMIN_STATIONARY_DELAY_MULT")

		PHX.UI:CreateVGUIType("","spacer",nil,grid,"" )
		PHX.UI:CreateVGUIType("", "label", "PHX.MenuCategoryLabel", grid, "PHXM_ADMIN_PROXIMITY_PANIC")
