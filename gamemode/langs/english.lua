...
-- GNC: Panic Mode translations
L["PHXM_ADMIN_PANIC_ENABLE"]				= "Enable Panic Mode (faster auto-taunt near round end)"
L["PHXM_ADMIN_PANIC_THRESHOLD"]				= "Panic Mode: Seconds remaining to trigger"
L["PHXM_ADMIN_PANIC_DELAY"]					= "Panic Mode: Taunt interval (seconds)"
-- GNC: Ready-Up System translations
L["PHXM_ADMIN_READYUP_ENABLE"]				= "Enable Ready-Up System"
L["PHXM_ADMIN_READYUP_THRESHOLD"]			= "Ready-Up: % of players needed"
L["PHXM_ADMIN_READYUP_COUNTDOWN"]			= "Ready-Up: Countdown duration (seconds)"
L["READYUP_TITLE"]							= "READY UP"
L["READYUP_PLAYERS_READY"]					= "players ready"
L["READYUP_NEEDED"]							= "(%d needed to start)"
L["READYUP_STARTING_IN"]					= "Starting in %d..."
L["READYUP_READY"]							= "READY UP!"
L["READYUP_UNREADY"]						= "CANCEL READY"
L["READYUP_STATUS_READY"]					= "READY"
L["READYUP_STATUS_NOT_READY"]				= "NOT READY"
L["READYUP_READY_SHORT"]					= "ready"
L["READYUP_YOU_ARE_READY"]					= "You are READY (F4 for panel)"
L["READYUP_PRESS_TO_READY"]					= "Press F4 to ready up"
L["READYUP_COUNTDOWN_STARTED"]				= "Ready threshold reached! Starting in %d seconds..."
L["READYUP_STARTING"]						= "All ready! Round starting..."
L["READYUP_ALL_READY"]						= "Everyone is ready! Starting now!"
L["READYUP_YOU_READY"]						= "You are now READY!"
L["READYUP_YOU_UNREADY"]					= "You are no longer ready."
L["READYUP_PRESS_KEY"]						= "Press F4 or click"
L["READYUP_JOIN_TEAM"]						= "Join a team to ready up"
L["READYUP_CHANGE_TEAM"]					= "Change Team"
...
L["PHXM_ADMIN_STATIONARY_TAUNT"]		= "Stationary Taunt Settings"
L["PHXM_ADMIN_STATIONARY_ENABLED"]		= "[Experimental] Being stationary increases taunt frequency and forces longer taunts."
L["PHXM_ADMIN_STATIONARY_THRESHOLD"]	= "Seconds of not moving before considered stationary"
L["PHXM_ADMIN_STATIONARY_MIN_DURATION"]	= "Minimum taunt duration (seconds) when stationary"
L["PHXM_ADMIN_STATIONARY_DELAY_MULT"]	= "Taunt delay multiplier when stationary (0.5 = twice as often)"

L["PHXM_ADMIN_PROXIMITY_PANIC"]			= "Proximity Panic Settings"
